...
const jupiterTexture = new THREE.TextureLoader().load("../images/profundidade_jupiter.jpg");
const geometry_jupiter = new THREE.SphereGeometry( 30, 50, 50);
const material_jupiter= new THREE.MeshPhongMaterial();
