...
const material_bebador = new THREE.MeshPhongMaterial({ color: 0xffffff, map: texturebebabor });
...
const material_bebado = new THREE.MeshPhongMaterial({ transparent: true });
